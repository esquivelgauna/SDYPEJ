...
public class DBUpdater {
    String conString = "jdbc:mysql://localhost:3306/db_net";
    ...
    public Boolean add(String name, String pos, String team) {
        //SQL STATEMENT
        String sql = "INSERT INTO datos(Name,Position,Team) VALUES('" + name + "','" + pos + "','" + team + "')";
    ...
    public Boolean update(String id, String name, String pos, String team) {
        //SQL STMT
        String sql = "UPDATE datos SET Name ='" + name + "',Position='" + pos + "',Team='" + team + "' WHERE ID='" + id + "'";
